...
```bash
aws cloudformation create-stack --stack-name s3-demo-surakshitha-stack --template-body file://s3-stack.yaml --parameters ParameterKey=EnvironmentName,ParameterValue=dev --profile devops
```
...
```bash
aws cloudformation describe-stacks --stack-name s3-demo-surakshitha-stack --profile devops
```
...
```bash
aws s3 mb s3://cf-template-storage-demo-surakshitha --profile devops
```
...
```bash
aws s3 cp network.yaml s3://cf-template-storage-demo-surakshitha/ --profile devops
```
...
```bash
aws cloudformation create-stack --stack-name parent-stack-surakshitha --template-body file://parent-stack.yaml --profile devops
```
...
```bash
aws cloudformation create-stack --stack-name dev-stack-surakshitha --template-body file://environment-stack.yaml --parameters ParameterKey=Environment,ParameterValue=dev --profile devops
```
...
```bash
aws cloudformation create-stack --stack-name test-stack-surakshitha --template-body file://environment-stack.yaml --parameters ParameterKey=Environment,ParameterValue=test --profile devops
```
...
```bash
aws cloudformation create-stack --stack-name prod-stack-surakshitha --template-body file://environment-stack.yaml --parameters ParameterKey=Environment,ParameterValue=prod --profile devops
```
