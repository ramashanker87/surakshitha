...
export NODEGROUP_NAME=surakshitha-eks-nodegroup
export ECR_REPO=surakshitha-ecr
export IMAGE_TAG=v2
export IMAGE_URI=386757865964.dkr.ecr.us-east-1.amazonaws.com/surakshitha-ecr:v2
export NAMESPACE=day17
export APP_NAME=surakshitha-ecr-app
```
...
aws iam create-role \
  --role-name eksClusterRole-surakshitha \
...
echo $SUBNET_IDS
```
##subnet-057c5b756944172f6 subnet-011365086c4759545
...
aws iam create-role \
  --role-name eksNodeGroupRole-surakshitha \
...
kind: Deployment
metadata:
  name: surakshitha-ecr-app
  namespace: day17-surakshitha
spec:
  replicas: 2
  selector:
    matchLabels:
      app: surakshitha-ecr-app
  template:
    metadata:
      labels:
        app: surakshitha-ecr-app
    spec:
      containers:
        - name: surakshitha-ecr-container
          image: 386757865964.dkr.ecr.us-east-1.amazonaws.com/surakshitha-ecr:v2
...
kubectl get deployments -n day17-surakshitha
kubectl get pods -n day17-surakshitha
kubectl describe pod surakshitha-ecr-app-6f64558dc8-fkgzv -n day17-surakshitha
kubectl logs surakshitha-ecr-app-6f64558dc8-fkgzv -n day17-surakshitha
```
...
kubectl get svc -n day17-surakshitha
kubectl get svc surakshitha-ecr-service -n day17-surakshitha --watch
```
...
```bash
export APP_URL=$(kubectl get svc surakshitha-ecr-service \
  -n day17-surakshitha \
...
kubectl get all -n day17-surakshitha
kubectl get pods -n day17-surakshitha -o wide
kubectl logs -n day17-surakshitha deployment/surakshitha-ecr-app
```
